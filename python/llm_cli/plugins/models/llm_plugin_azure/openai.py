"""Azure AI Foundry OpenAI provider for LLM."""
...
class AzureOpenAIShared(_Shared):
    ...
    def get_client(self, key: str, *, async_: bool = False) -> AzureOpenAI:
        if not key:
            raise RuntimeError(
...
# Chat model
# =================================================
class AzureOpenAIChat(AzureOpenAIShared, KeyModel):  # type: ignore[misc]
    can_stream = True
    vision = True
    supports_tools = True
